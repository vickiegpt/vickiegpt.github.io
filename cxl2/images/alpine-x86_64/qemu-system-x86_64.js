...
function findWasmBinary() {
  ...
  return new URL('qemu-system-x86_64.wasm?v=20260514-clean1', import.meta.url).href;
}
...
// end include: preamble.js
  ...
  allocateUnusedWorker() {
        ...
        worker = new Worker(new URL('qemu-system-x86_64.js?v=20260514-clean1', import.meta.url), workerOptions);
        PThread.unusedWorkers.push(worker);
      },
  getNewWorker() {
