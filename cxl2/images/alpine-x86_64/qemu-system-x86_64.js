...
["___indirect_function_table","___em_lib_deps_libffi","_unbox_small_structs","_ffi_call_js","_ffi_closure_alloc_js","_ffi_closure_free_js","_ffi_prep_closure_loc_js","__emscripten_proxy_main","_main","onRuntimeInitialized"].forEach((prop) => {
...
var ASM_CONSTS = {
  9908848: () => { if (typeof console !== 'undefined') { console.log('[hetGPU WebGPU] backend selected'); } return 0; },  
 9908951: () => { if (typeof navigator !== 'undefined' && navigator.gpu) { return 1; } return 1; },  
 9909034: ($0) => { if (typeof console !== 'undefined') { console.log('[hetGPU WebGPU] module load, bytes=' + $0); } },  
 9909135: ($0, $1) => { if (typeof console !== 'undefined') { var n = UTF8ToString($1); console.log('[hetGPU WebGPU] get function module=' + $0 + ' name=' + n); } },  
 9909278: ($0, $1, $2, $3, $4, $5, $6, $7, $8) => { if (typeof console !== 'undefined') { var n = UTF8ToString($1); console.log('[hetGPU WebGPU] launch kernel=' + $0 + ' name=' + n + ' grid=(' + $2 + ',' + $3 + ',' + $4 + ')' + ' block=(' + $5 + ',' + $6 + ',' + $7 + ')' + ' shared=' + $8); } }
};
...
// end include: preamble.js
  ...
  allocateUnusedWorker() {
        ...
        worker = new Worker(new URL('qemu-system-x86_64.js?v=20260512-o3', import.meta.url), workerOptions);
        PThread.unusedWorkers.push(worker);
      },
  getNewWorker() {
...
function applySignatureConversions(wasmExports) {
  ...
  const wrap = (name, makeWrapper) => {
    if (typeof wasmExports[name] == 'function') {
      wasmExports[name] = makeWrapper(wasmExports[name]);
    }
  };
  const ptr0 = f => () => f() >>> 0;
  const ptr1 = f => a0 => f(a0) >>> 0;
  const ptr2 = f => (a0, a1) => f(a0, a1) >>> 0;
  wrap('__errno_location', ptr0);
  wrap('malloc', ptr1);
  wrap('pthread_self', ptr0);
  wrap('emscripten_builtin_memalign', ptr2);
  wrap('emscripten_main_runtime_thread_id', ptr0);
  wrap('stackSave', ptr0);
  wrap('stackAlloc', ptr1);
  return wasmExports;
}
