...
var ASM_CONSTS = {
  9883968: () => { if (typeof console !== 'undefined') { console.log('[hetGPU WebGPU] backend selected'); } return 0; },  
 9884071: () => { if (typeof navigator !== 'undefined' && navigator.gpu) { return 1; } return 1; },  
 9884154: ($0) => { if (typeof console !== 'undefined') { console.log('[hetGPU WebGPU] module load, bytes=' + $0); } },  
 9884255: ($0, $1) => { if (typeof console !== 'undefined') { var n = UTF8ToString($1); console.log('[hetGPU WebGPU] get function module=' + $0 + ' name=' + n); } },  
 9884398: ($0, $1, $2, $3, $4, $5, $6, $7, $8) => { if (typeof console !== 'undefined') { var n = UTF8ToString($1); console.log('[hetGPU WebGPU] launch kernel=' + $0 + ' name=' + n + ' grid=(' + $2 + ',' + $3 + ',' + $4 + ')' + ' block=(' + $5 + ',' + $6 + ',' + $7 + ')' + ' shared=' + $8); } }
};
