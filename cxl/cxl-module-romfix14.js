...
function parseImageConfig(params) {
    ...
    const initrdVersion = initrdProfile === 'hpc' ? '20260518-hpc-romfix14' : '20260518-tools2';
    const hpcKernelVersion = '20260518-romfix14';
    ...
    const defaultInitrdUrl = initrdProfile === 'hpc' && /^asplos\.dev$/i.test(location.hostname)
        ? `https://raw.githubusercontent.com/vickiegpt/vickiegpt.github.io/main/cxl/images/alpine-x86_64/${initrdName}?v=${initrdVersion}`
...
const CXL_WEB_CONFIG = (() => {
    ...
    return {
        ...
        cxlmemsim: {
            ...
            pool: cxlmemsim.pool,
            size: cxlmemsimSize,
            workerUrl: '/cxl/cxlmemsim-pool-worker.js?v=20260518-multihost1',
