...
const CXL_WEB_CONFIG = (() => {
    ...
    return {
        ...
        qemuMainScript: qemuCore === 'fast' ? 'out-noexit2.js' : 'out.js',
        qemuPthreadScript: qemuCore === 'fast' ? 'qemu-system-x86_64-noexit2.js' : 'qemu-system-x86_64.js',
        image,
        network: {
        ...
        cxlmemsim: {
            ...
            pool: cxlmemsim.pool,
            size: cxlmemsimSize,
            workerUrl: '/cxl/cxlmemsim-pool-worker.js?v=20260521-noexit2',
            workerName: 'hetgpu-cxlmemsim-20260521-noexit2'
        },
        webgpuNative
    };
})();
