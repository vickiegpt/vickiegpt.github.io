...
const CXL_WEB_CONFIG = (() => {
    ...
    return {
        ...
        qemuMainScript: qemuCore === 'fast' ? 'out-noexit1.js' : 'out.js',
        qemuPthreadScript: qemuCore === 'fast' ? 'qemu-system-x86_64-noexit1.js' : 'qemu-system-x86_64.js',
        image,
        network: {
        ...
        cxlmemsim: {
            ...
            pool: cxlmemsim.pool,
            size: cxlmemsimSize,
            workerUrl: '/cxl/cxlmemsim-pool-worker.js?v=20260521-noexit1',
