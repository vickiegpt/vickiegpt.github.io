...
var ASM_CONSTS = {
  9897216: () => { if (typeof console !== 'undefined') { console.log('[hetGPU WebGPU] backend selected'); } return 0; },  
 9897319: () => { if (typeof navigator !== 'undefined' && navigator.gpu) { return 1; } return 1; },  
 9897402: ($0) => { if (typeof console !== 'undefined') { console.log('[hetGPU WebGPU] module load, bytes=' + $0); } },  
 9897503: ($0, $1) => { if (typeof console !== 'undefined') { var n = UTF8ToString($1); console.log('[hetGPU WebGPU] get function module=' + $0 + ' name=' + n); } },  
 9897646: ($0, $1, $2, $3, $4, $5, $6, $7, $8) => { if (typeof console !== 'undefined') { var n = UTF8ToString($1); console.log('[hetGPU WebGPU] launch kernel=' + $0 + ' name=' + n + ' grid=(' + $2 + ',' + $3 + ',' + $4 + ')' + ' block=(' + $5 + ',' + $6 + ',' + $7 + ')' + ' shared=' + $8); } }
};
...
// end include: preamble.js
  ...
  allocateUnusedWorker() {
        ...
        worker = new Worker(new URL('qemu-system-i386.js', import.meta.url), workerOptions);
        PThread.unusedWorkers.push(worker);
      },
  getNewWorker() {
